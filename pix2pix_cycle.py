...
def my_train(args):
    ...
    procImage1, rawImage1 = my_load_data_train(args.datasetpath10)
    ...
    generator_model.load_weights('params_generator1_pix_epoch_1500.hdf5')
    # load discriminator model
    discriminator_model = models.my_load_DCGAN_discriminator(img_shape, disc_img_shape, patch_num)
    discriminator_model.load_weights('params_discriminator1_pix_epoch_1500.hdf5')
...
def main():
    ...
    parser.add_argument('--datasetpath10', '-d_train1', type=str, default ="airp2nekoRaw_train.hdf5")  #,  "required=True)
    parser.add_argument('--datasetpath01', '-d_test0', type=str, default ="neko2airpRaw_test.hdf5")   #, required=True)
    parser.add_argument('--datasetpath11', '-d_test1', type=str, default ="airp2nekoRaw_test.hdf5")   #, required=True)
    parser.add_argument('--patch_size', '-p', type=int, default=64)
    parser.add_argument('--batch_size', '-b', type=int, default=5)
    parser.add_argument('--epoch','-e', type=int, default=2001)
